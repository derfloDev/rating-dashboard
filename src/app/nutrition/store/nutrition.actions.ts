...
export const searchProducts = createAction('[Nutrition] search products', props<{ tag: string }>());
export const productsLoaded = createAction('[Nutrition] products loaded', props<{ products: Product[] }>());
export const productsLoadedError = createAction('[Nutrition] products loaded error', props<{ error: any }>());
